  ...
  return (
    ...
    >
      <MediaPlayerTooltip tooltip="Playback speed" shortcut={['<', '>']}>
        <DropdownMenuTrigger render={<Button type="button" aria-controls={context.mediaId} disabled={isDisabled} {...playbackSpeedProps} variant="ghost" size="icon" className={cn('aria-expanded:bg-accent/50 h-8 w-16', className)} />}>{mediaPlaybackRate}x
                        </DropdownMenuTrigger>
      </MediaPlayerTooltip>
      <DropdownMenuContent
  ...
  return (
    ...
    >
      <MediaPlayerTooltip tooltip="Settings">
        <DropdownMenuTrigger render={<Button type="button" aria-controls={context.mediaId} aria-label="Settings" data-disabled={isDisabled ? '' : undefined} data-slot="media-player-settings" disabled={isDisabled} {...settingsProps} variant="ghost" size="icon" className={cn('aria-expanded:bg-accent/50 size-8', className)} />}><SettingsIcon /></DropdownMenuTrigger>
      </MediaPlayerTooltip>
      <DropdownMenuContent
        align="end"
        side="top"
